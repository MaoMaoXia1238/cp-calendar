...
export default function Footer() {
  return (
    <footer
      style={{ background: "var(--midnight-deep)", borderTop: "1px solid var(--border-subtle)" }}
    >
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p style={{ color: "var(--text-secondary)" }}>Never miss a contest again.</p>
          </div>
          ...
          <div>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-4 py-2 rounded-lg transition-all hover:bg-[var(--midnight-highlight)]"
